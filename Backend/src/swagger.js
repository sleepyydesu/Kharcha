...
const swaggerSpec = {
    ...
    schemas: {
      ...
      SigninAccountObject: {
        ...
        properties: {
          ...
          mpin_set: {
            type: "boolean",
            description: "Whether the user has configured their MPIN yet",
            example: false,
          },
        },
      },
      ...
      ApiKeyInfo: {
        ...
        properties: {
          ...
          key_prefix: {
            ...
            description: "First 12 chars of the key — for identification only",
          },
  ...
  tags: [
    ...
    {
      name: "Profile",
      description: "View and update profile, upload/remove profile picture",
    },
    {
      name: "Wallet",
  ...
  paths: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  signup_token: {
                    type: "string",
                    description: "Token received from the verify-otp step",
                    example: "eyJhbGciOiJIUzI1NiIsInR5...",
                  },
                  account_type: {
                    type: "string",
                  ...
                  full_name: {
                    type: "string",
                    description: "Required for user and admin",
                    example: "John Doe",
                  },
                  organization_name: {
                    type: "string",
                    description: "Required for organization",
                    example: "Acme Corp",
                  },
                },
              },
    ...
    "/api/auth/mpin/setup": {
      post: {
        ...
        responses: {
          ...
          401: {
            description: "No/invalid auth token — or incorrect password",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
          ...
          409: {
            description: "MPIN already set — use /mpin/change instead",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
    ...
    "/api/auth/mpin/change": {
      post: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  current_mpin: {
                    type: "string",
                    description: "Your existing 6-digit MPIN",
                    example: "123456",
                  },
                  new_mpin: {
                    type: "string",
                    description: "New 6-digit MPIN (must differ from current)",
                    example: "654321",
                  },
                },
              },
        ...
        responses: {
          ...
          401: {
            description: "No/invalid auth token — or incorrect current MPIN",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
          ...
          403: {
            description: "MPIN not yet set up — use /mpin/setup first",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
              ...
              schema: {
                ...
                properties: {
                  ...
                  full_name: {
                    type: "string",
                    example: "John Doe",
                    description: "User / admin accounts only",
                  },
                  organization_name: {
                    type: "string",
                    example: "Acme Corp",
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "This phone number is already in use.",
                    },
                  },
                },
              },
    ...
    "/api/wallet/transfer": {
      post: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  receiver_identifier: {
                    type: "string",
                    description: "Receiver phone number or account UUID",
                    example: "+9779811111111",
                  },
                  amount: {
                    type: "number",
                    description: "Amount in NPR (minimum 1)",
                    example: 500,
                  },
                  mpin: {
                    type: "string",
        ...
        responses: {
          ...
          429: {
            description: "Too many transfer requests — rate limited",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
    ...
    "/api/transactions/org-types": {
      get: {
        ...
        responses: {
          410: {
            description: "Gone — use GET /api/profile/org-types instead",
          },
        },
      },
    },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "Date range cannot exceed 3 months.",
                    },
                  },
                },
                examples: {
    ...
    "/api/cards/request": {
      post: {
              ...
              schema: {
                ...
                properties: {
                  delivery_address: {
                    ...
                    description: "Optional delivery address for the card",
                  },
                },
              },
            },
        ...
        responses: {
          ...
          409: {
            description: "A pending request or active card already exists",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    pending_request: {
                      ...
                      description: "Populated only when card is null",
                    },
                  },
                },
              },
              ...
              schema: {
                ...
                properties: {
                  daily_limit: {
                    type: "number",
                    example: 50000,
                    description: "New daily limit in NPR (100 – 100,000)",
                  },
                },
              },
            },
              ...
              schema: {
                ...
                properties: {
                  ...
                  account_id: {
                    type: "string",
                    format: "uuid",
                    description: "UUID of the user account to link the card to",
                  },
                  request_id: {
                    type: "string",
                    format: "uuid",
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    api_key: {
                      ...
                      description: "Full raw key — shown ONCE, never again",
                    },
                    key_info: {
    ...
    "/api/pos/charge": {
      post: {
              ...
              schema: {
                ...
                properties: {
                  ...
                  remarks: {
                    ...
                    description: "Optional receipt reference or note",
                  },
                },
              },
              examples: {
        ...
        responses: {
                      ...
                      properties: {
                        ...
                        merchant: {
                          ...
                          properties: {
                            ...
                            display_name: {
                              type: "string",
                              example: "Bhatbhateni Superstore",
                            },
                          },
                        },
                        remarks: {
          ...
          403: {
            description: "Card is not active (blocked, pending, or expired)",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
    ...
    "/api/khalti/initiate": {
      post: {
        ...
        responses: {
          200: {
            description:
              "Payment session created — redirect user to payment_url",
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example:
                        "Payment initiated. Redirect the user to payment_url.",
                    },
                    pidx: {
                      type: "string",
                      description:
                        "Khalti payment token — store this if you want to track the session",
                      example: "HT6o2sQfNxuAFJHJmDPNnR",
                    },
                    payment_url: {
                      type: "string",
                      description:
                        "Redirect the user to this URL to complete payment on Khalti",
                      example:
                        "https://dev.khalti.com/payment/HT6o2sQfNxuAFJHJmDPNnR/",
                    },
                  },
                },
              },
            ...
            content: {
              "application/json": {
                ...
                example: {
                  success: true,
                  message:
                    "If an account exists for john@example.com, a reset code has been sent. Valid for 10 minutes.",
                },
              },
            },
          },
    ...
    "/api/auth/password/reset": {
      post: {
        ...
        responses: {
          ...
          400: {
            description:
              "Missing fields, invalid OTP, expired OTP, or password too short",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
            ...
            content: {
              "application/json": {
                ...
                example: {
                  success: true,
                  message:
                    "If an account exists for john@example.com, an MPIN reset code has been sent. Valid for 10 minutes.",
                },
              },
            },
          },
    ...
    "/api/auth/mpin/reset": {
      post: {
        ...
        responses: {
          ...
          400: {
            description:
              "Missing fields, invalid OTP, expired OTP, or MPIN not 6 digits",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
            ...
            content: {
              "application/json": {
                ...
                example: {
                  success: false,
                  message:
                    "Only user accounts can submit verification requests.",
                },
              },
            },
          },
              ...
              schema: {
                ...
                properties: {
                  ...
                  admin_notes: {
                    type: "string",
                    description:
                      "Optional notes from the reviewing admin (stored on the request)",
    ...
    "/api/admin/create": {
      post: {
              ...
              schema: {
                ...
                properties: {
                  ...
                  bootstrap_code: {
                    type: "string",
                    description:
                      "Required only when no admins exist yet (bootstrap mode). Must match ADMIN_BOOTSTRAP_CODE on the server.",
        ...
        responses: {
          ...
          403: {
            description:
              "Not an admin (when admins exist) or invalid/missing bootstrap code",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
    ...
    "/api/khalti/verify": {
      get: {
        ...
        parameters: [
          {
            ...
            required: true,
            description:
              "Khalti payment token (appended automatically by Khalti)",
          ...
          },
          {
            ...
            required: false,
            description:
              "Payment status sent by Khalti (e.g. Completed, Pending, User canceled)",
        ...
        responses: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "NPR 500 loaded into your Kharcha wallet.",
                    },
                    transaction_id: { type: "string", format: "uuid" },
          ...
          500: {
            description:
              "Payment not completed by user, or Khalti/server error",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
              },
                    ...
                    services: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          name: { type: "string", example: "NTC" },
                          category: {
                            type: "string",
                            example: "Mobile Top Up",
                          },
                          requires: { type: "string", example: "phone_number" },
                        },
                      },
                    },
                  },
        ...
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                required: ["service_key", "amount", "identifier", "mpin"],
                properties: {
                  service_key: { type: "string", example: "ncell" },
                  amount: { type: "number", example: 10 },
                  identifier: { type: "string", example: "9800000001" },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "Ncell payment successful.",
                    },
                    data: {
                      type: "object",
                      properties: {
                        service: { type: "string", example: "Ncell" },
                        category: { type: "string", example: "Mobile Top Up" },
                        identifier: { type: "string", example: "9800000001" },
                        amount: { type: "number", example: 10 },
                        transaction_id: {
                          type: "string",
                          example: "b37e37e0-8a81-4ff2-82ed-e5332dbf92eb",
                        },
                        balance_after: { type: "number", example: 929 },
                      },
                    },
                  },
                },
          ...
          content: {
            "application/json": {
              schema: {
                ...
                required: ["service_key", "amount", "identifier", "mpin"],
                properties: {
                  service_key: { type: "string", example: "nea" },
                  amount: { type: "number", example: 20 },
                  identifier: { type: "string", example: "rishen@example.com" },
                  mpin: { type: "string", example: "123456" },
                },
              },
            },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "NEA payment successful.",
                    },
                    data: {
                      type: "object",
                      properties: {
                        service: { type: "string", example: "NEA" },
                        category: {
                          type: "string",
                        ...
                        identifier: {
                          type: "string",
                          example: "rishen@example.com",
                        },
                        amount: { type: "number", example: 20 },
                        transaction_id: {
                          type: "string",
                          example: "f42ad572-03c5-4d5a-80f3-303925679538",
                        },
                        balance_after: { type: "number", example: 939 },
                      },
                    },
                  },
                },
