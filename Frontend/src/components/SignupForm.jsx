...
function SignupForm({ onLogin }) {
    ...
    function validateStep2() {
        ...
        if (form.phone_number && !/^(97|98)\d{8}$/.test(form.phone_number)) {
            e.phone_number =
                "Enter a valid Nepali number (97XXXXXXXX or 98XXXXXXXX)";
        }
    ...
    async function verifyOtpAndComplete() {
        ...
        try {
            ...
            if (!verifyData.success) {
                setErrors({
                    otp:
                        verifyData.message || "Invalid code. Please try again.",
                });
                setLoading(false);
                return;
            }
            ...
            if (accountType === "user") {
                ...
                completePayload.organization_name =
                    form.organization_name.trim();
            }

            if (form.phone_number) {
                completePayload.phone_number = normalizePhone(
                    form.phone_number,
                );
            }
                    ...
                    <div className="type-cards">
                        ...
                        >
                            ...
                            <div className="type-card-text">
                                ...
                                <p>
                                    For individuals – send, receive &amp; manage
                                    money
                                </p>
                            </div>
                        </button>
                        ...
                        >
                            ...
                            <div className="type-card-text">
                                ...
                                <p>
                                    For businesses – collect payments &amp;
                                    manage payroll
                                </p>
                            </div>
                        </button>
            ...
            {step === 4 && (
                ...
                >
                    ...
                    <p className="step-subtitle">
                        ...
                        {form.phone_number ? " or phone number" : ""} and the
                        password you set.
                    </p>
                    <button
                        className="btn-primary"
