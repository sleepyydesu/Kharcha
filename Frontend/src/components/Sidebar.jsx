...
import expenseIcon from "../assets/walletIcon.svg"; // ✅ reuse or replace with your expense icon
    ...
    <>
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar__menu">
          ...
          {/* ✅ EXPENSES - ADDED */}
          <button
            className={`sidebar__item ${at("/expenses") ? "sidebar__item--active" : ""}`}
            onClick={() => navigate("/expenses")}
          >
            <img src={expenseIcon} className="sidebar__icon" alt="" />
            <span>Expenses</span>
          </button>
      ...
      <nav className="bottom-nav">
        ...
        {/* ✅ EXPENSES - ADDED IN BOTTOM NAV */}
        <button
          className={`bnav__item ${at("/expenses") ? "bnav__item--active" : ""}`}
          onClick={() => {
            setMobileOpen(null);
            navigate("/expenses");
          }}
        >
          <img src={expenseIcon} className="bnav__icon" alt="" />
          <span className="bnav__label">Expenses</span>
        </button>

        {/* QR — centred, no label */}
        <div className="bnav__qr-wrap">
          <button
            className={`bnav__qr ${at("/qr") ? "bnav__qr--active" : ""}`}
            onClick={() => {
              setMobileOpen(null);
              navigate("/qr");
            }}
