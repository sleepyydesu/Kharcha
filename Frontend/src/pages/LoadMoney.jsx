...
import { initiateKhalti, redeemGiftCard, initiateEsewa } from "../services/api";
  ...
  return (
    <div className="lm__choose">
      ...
      <div className="lm__methods">
        ...
        <button className="lm__method-card" onClick={() => onSelect("esewa")}>
          <div className="lm__method-icon lm__method-icon--esewa">
            <img src={esewaIcon} alt="eSewa" />
          </div>
          <div className="lm__method-info">
            <span className="lm__method-name">Load with eSewa</span>
            <span className="lm__method-desc">
              Pay instantly via your eSewa wallet
            </span>
          </div>
          <span className="lm__method-arrow">›</span>
        </button>
...
function EsewaView() {
  ...
  async function handlePay() {
    ...
    setError("");
    try {
      const d = await initiateEsewa(amt);

      // eSewa uses form POST — build and submit a hidden form
      const form = document.createElement("form");
      form.method = "POST";
      form.action = d.gateway_url;

      Object.entries(d.formParams).forEach(([key, value]) => {
      ...
      console.log("eSewa form params:", d.formParams);
      console.log("transaction_uuid:", d.formParams.transaction_uuid);
  ...
  return (
    <div className="lm__form-wrap">
      <div className="lm__form-header lm__form-header--esewa">
        <img src={esewaIcon} alt="eSewa" className="lm__form-header-img" />
        <div>
          <h2 className="lm__form-title">Load with eSewa</h2>
          <p className="lm__form-sub">Enter the amount you want to load</p>
        </div>
      </div>
      ...
      <button
        className="lm__pay-btn lm__pay-btn--esewa"
        onClick={handlePay}
        disabled={loading || !amount}
      >
  ...
  if (success) {
    return (
      <div className="lm__success">
        ...
        <button className="lm__pay-btn lm__pay-btn--gift" onClick={onSuccess}>
          Done
        </button>
      </div>
    );
...
export default function LoadMoney() {
  ...
  return (
    <div className="lm">
      ...
      {/* Gift card QR scan result banner */}
      {hasGiftcardResult && (
        <GiftcardQRBanner params={searchParams} onDismiss={dismissBanner} />
      )}
