            ...
            getTransactionCategories()
                .then(d => {
                    ...
                    if (defaultCategoryId && !selectedCat) {
                        const found = cats.find(c => String(c.category_id) === String(defaultCategoryId));
                ...
                <div className="sm__confirm-card">
                    ...
                    {fromDynamicQR && (
                        <div className="sm__confirm-row">
                            ...
                            <span className="sm__confirm-val" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
            ...
            <div className="sm">
                ...
                <div className="sm__field">
                    ...
                    <div className={`sm__input-row${lookupErr ? " sm__input-row--err" : ""}`}>
                        <UserIcon />
                        <input className="sm__input" type="tel"
        ...
        <div className="sm">
            ...
            {showExtra && (
                <div className="sm__extra">
                    <div className="sm__extra-divider"><span>Category &amp; Remarks</span></div>
                            ...
                            {categories.map(cat => (
                                <button key={cat.category_id}
                                    ...
                                    <span className="sm__cat-icon">
                                        {cat.icon ? <img src={cat.icon} alt={cat.name} className="sm__cat-img" /> : "💳"}
                                    </span>
                    ...
                    <div className="sm__field">
                        ...
                        <input
                            ...
                            onChange={e => { setRemarks(e.target.value); if (remarksErr) setRemarksErr(""); }}
                        />
                        {remarksErr
                            ? <p className="sm__field-err">{remarksErr}</p>
                            : <p className="sm__field-hint">Required — briefly describe what this payment is for.</p>
                        }
                    </div>
